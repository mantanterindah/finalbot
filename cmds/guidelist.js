...
module.exports.run = async (bot, message, args) => {
	...
	let embedrebirth = new Discord.RichEmbed()
		...
		//message.channel.send(embed);
	let embedrebirth2 = new Discord.RichEmbed()
		.setTitle('[New] Benefit Rebirth on Siti Badriah')
		.setImage('https://cdn.discordapp.com/attachments/496692039732166667/498897430352494612/unknown.png')
		.setThumbnail('https://cdn.discordapp.com/attachments/496692039732166667/498897606953533460/unknown.png')
		.setTimestamp()
		.addURL('http://rektnarok.boards.net/thread/8/rektnarok-rebirth-system')
		//.addField('','')
		//.addField('','')
		.addField('Benefit Quest Siti Badriah Reward','Costume Dragon Helm\nCostume Eremes Scraft\nCostume Decoration Time\nSpecial Aura Top,Middle,Bottom\nSafe to 7 Certificate Armor & Weapon');
	...
	let embedquesthimpunantani = new Discord.RichEmbed()
		.setTitle('Himpunan Tani Midgard Quest')
		//.setImage('')
		.setThumbnail('https://cdn.discordapp.com/attachments/496692039732166667/496713097117958144/unknown.png')
		.setColor('#f44256')
		.setTimestamp()
		.addField('NPC','**Pak Joko Wibowo**\nLocation at Gonryun 124 140')
		.addField('Story Line Quest','Part 1 :\n\nBicaralah Kepada Pak Joko untuk meminta quest pertama untuk ikut himpunan tani,\nSetelah itu kamu akan di suruh membunuh Stem Worm sebanyak **250** kali\nSetelah itu kembalilah ke Pak Joko dan Bicaralah dengannya.')
		.addField('Story Line Quest','Part 2 :\n\nSetelah menyelesaikan quest part 1.\nKamu akan di suruh mengumpulkan beberapa bahan dan zeny untuk biaya keanggotaan yaitu :\n\n- 1x Sakkat\n- 5x White Herb\n- 5x Blue Herb\n- 20x Mastela Fruit\n- Zeny 1.000.000z\nSetelah itu Pak Joko Akan Memberimu Costume Sakkat\nCongrats :D');

	let embedquesthalloween = new Discord.RichEmbed()
		.setTitle('Halloween Quest Event')
		.setURL('http://rektnarok.boards.net/thread/32/halloween-event-quest')
		.setTimestamp();
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

	//COSTUME EGG UPDATE FUTURE///////////////////////////////////////////////////////////////////////////////////////////
	//VERY RARE/////////////////////////////////////
	let embedcostveryrare1 = new Discord.RichEmbed()
		.setTitle('Costume PiggyBack')
		.setImage('https://cdn.discordapp.com/attachments/496692039732166667/496692615975272449/unknown.png')
		.setThumbnail('https://cdn.discordapp.com/attachments/496692039732166667/496692153100271616/unknown.png')
		.setColor('#19d613')
		.setTimestamp();
		//.addField('','')
		//.addField('','')
	...
	let embedcostveryrare2 = new Discord.RichEmbed()
		.setTitle('Costume Vicious Aura Mind')
		.setImage('https://cdn.discordapp.com/attachments/496692039732166667/496693261159759881/unknown.png')
		.setThumbnail('https://cdn.discordapp.com/attachments/496692039732166667/496692836671160335/unknown.png')
		.setColor('#19d613')
		.setTimestamp();
		//.addField('','')
		//.addField('','')
	...
	let embedcostveryrare3 = new Discord.RichEmbed()
		.setTitle('C Poring Muffler')
		.setImage('https://cdn.discordapp.com/attachments/496692039732166667/496694417285972000/unknown.png')
		.setThumbnail('https://cdn.discordapp.com/attachments/496692039732166667/496693857635794944/unknown.png')
		.setColor('#19d613')
		.setTimestamp();
		//.addField('','')
		//.addField('','')
	...
	//RARE ////////////////////////////////////////
	let embedcostrare1 = new Discord.RichEmbed()
		.setTitle('Costume Buring Sun(Lower)')
		.setImage('https://cdn.discordapp.com/attachments/496692039732166667/496694853078351872/unknown.png')
		.setThumbnail('https://cdn.discordapp.com/attachments/496692039732166667/496694613965406208/unknown.png')
		.setColor('#e8ef0b')
		.setTimestamp();
		//.addField('','')
		//.addField('','')
	...
	let embedcostrare2 = new Discord.RichEmbed()
		.setTitle('Costume Leopard Ear Hat')
		.setImage('https://cdn.discordapp.com/attachments/496692039732166667/496696129258520586/unknown.png')
		.setThumbnail('https://cdn.discordapp.com/attachments/496692039732166667/496695081873571860/unknown.png')
		.setColor('#e8ef0b')
		.setTimestamp();
		//.addField('','')
		//.addField('','')
	...
	let embedcostrare3 = new Discord.RichEmbed()
		.setTitle('Costume Bragi Ear')
		.setImage('https://cdn.discordapp.com/attachments/496692039732166667/496695929106333697/unknown.png')
		.setThumbnail('https://cdn.discordapp.com/attachments/496692039732166667/496695723480580107/unknown.png')
		.setColor('#e8ef0b')
		.setTimestamp();
		//.addField('','')
		//.addField('','')
	...
	let embedcostrare4 = new Discord.RichEmbed()
		.setTitle('Costume Coiledup Snake Hat')
		.setImage('https://cdn.discordapp.com/attachments/496692039732166667/496696732432728065/unknown.png')
		.setThumbnail('https://cdn.discordapp.com/attachments/496692039732166667/496696542112251914/unknown.png')
		.setColor('#e8ef0b')
		.setTimestamp();
		//.addField('','')
		//.addField('','')
	...
	let embedcostrare5 = new Discord.RichEmbed()
		.setTitle('Costume Metal Dragon Hat')
		.setImage('https://cdn.discordapp.com/attachments/496692039732166667/496697370306805791/unknown.png')
		.setThumbnail('https://cdn.discordapp.com/attachments/496692039732166667/496697035966119971/unknown.png')
		.setColor('#e8ef0b')
		.setTimestamp();
		//.addField('','')
		//.addField('','')
	...
	//COMMON///////////////////////////////////////
	let embedcostcommon1 = new Discord.RichEmbed()
		.setTitle('Costume Cow Hat 3')
		.setImage('https://cdn.discordapp.com/attachments/496692039732166667/496697834528309252/unknown.png')
		.setThumbnail('https://cdn.discordapp.com/attachments/496692039732166667/496697702793347072/unknown.png')
		.setColor('#ef0b39')
		.setTimestamp();
		//.addField('','')
		//.addField('','')
	...
	let embedcostcommon2 = new Discord.RichEmbed()
		.setTitle('Costume Aura Quartz')
		.setImage('https://cdn.discordapp.com/attachments/496692039732166667/496698997654683668/unknown.png')
		.setThumbnail('https://cdn.discordapp.com/attachments/496692039732166667/496698243229417502/unknown.png')
		.setColor('#ef0b39')
		.setTimestamp();
		//.addField('','')
		//.addField('','')
	...
	let embedcostcommon3 = new Discord.RichEmbed()
		.setTitle('Costume Silk Hat of Earth')
		.setImage('https://cdn.discordapp.com/attachments/496692039732166667/496699339633066005/unknown.png')
		.setThumbnail('https://cdn.discordapp.com/attachments/496692039732166667/496699186071339028/unknown.png')
		.setColor('#ef0b39')
		.setTimestamp();
		//.addField('','')
		//.addField('','')
	...
	let embedcostcommon4 = new Discord.RichEmbed()
		.setTitle('Costume School Criatura Hat')
		.setImage('https://cdn.discordapp.com/attachments/496692039732166667/496699941796839424/unknown.png')
		.setThumbnail('https://cdn.discordapp.com/attachments/496692039732166667/496699604654358558/unknown.png')
		.setColor('#ef0b39')
		.setTimestamp();
		//.addField('','')
		//.addField('','')
	...
	let embedcostcommon5 = new Discord.RichEmbed()
		.setTitle('Costume Coppola')
		.setImage('https://cdn.discordapp.com/attachments/496692039732166667/496700255421857802/unknown.png')
		.setThumbnail('https://cdn.discordapp.com/attachments/496692039732166667/496700142024392715/unknown.png')
		.setColor('#ef0b39')
		.setTimestamp();
		//.addField('','')
		//.addField('','')
	...
	collector.on('collect', message => {
		...
		if(message.content === '8') {
			...
			message.channel.send(embedrebirth2)
		}
		...
		if(message.content === '13') {
			...
			collectorquest.on('collect', message => {
				...
				if(message.content === 'c') {
					message.channel.send(embedquesthimpunantani)
				}
				if(message.content === 'd') {
					message.channel.send(embedquesthalloween)
				}
			})
		...
		if(message.content === '14') {
			let msg5 = message.channel.send('```diff\nPlease Type a b or c to more Information :\n\n- a. Very Rare\n- b. Rare\n- c. Common```')
			const collectorcostume = new Discord.MessageCollector(message.channel, m => m.author.id === message.author.id, {time: 10000});
			console.log(collectorcostume)
			collectorcostume.on('collect', message => {
				if(message.content === 'a') {
					message.channel.send(embedcostveryrare1)
					message.channel.send(embedcostveryrare2)
					message.channel.send(embedcostveryrare3)
				}
				if(message.content === 'b') {
					message.channel.send(embedcostrare1)
					message.channel.send(embedcostrare2)
					message.channel.send(embedcostrare3)
					message.channel.send(embedcostrare4)
					message.channel.send(embedcostrare5)
				}
				if(message.content === 'c') {
					message.channel.send(embedcostcommon1)
					message.channel.send(embedcostcommon2)
					message.channel.send(embedcostcommon3)
					message.channel.send(embedcostcommon4)
					message.channel.send(embedcostcommon5)
				}
			})
		}
